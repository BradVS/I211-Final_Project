/*
 * This script is for our AJAX to autosuggest movies to users depending on what they enter into the search bar
 */
var xmlHttp;
...
function displayTitles(titles) {
    ...
    for (i = 0; i < titles.length; i++) {
        divContent += "<p id=s_" + i + " onclick='clickTitle(this)'>" + titles[i] + "</p>";
    }
